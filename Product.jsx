...
opacity-100"
    >
      {/*Product data */}
      <div className="flex gap-12 am:gamp-12 flex-col sm:flex-row">
        {/* Product images*/}

        <div
          className="flex-1 flex flex-col-reverse gap-3
sm:flex-row"
        >
          <div
...
mt-5 flex flex-col gap-1"
      ...
      {/* -------------Descrription and review section-----------------*/}
      ...
      <div className=" mt-29">
        ...
        <div
          className="flex flex-col gap-4 border px-6 py-6 text-sm 
text-gray-500 "
        >
          <p>
